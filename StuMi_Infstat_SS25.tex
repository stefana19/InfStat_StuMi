...
\subsubsection{Verteilung des (skalierten) Fehlers von MM-Schätzern}
	...
	Betrachtet man hierbei den mittleren quadratsichen Fehler:
	...
	\begin{BSP}[Beispiel 1.4.1 (Noten Effizienz und Zulässigkeit)]
		...
		\begin{align*}
			...
			\end{tabular}
		\end{align*}
		$\textbf{B}$ ist hier unzulässig, weil dieser Schüler immer schlechter als $\textbf{A}$ oder auch $\textbf{D}$ ist. 
	...
	\begin{BSP}[Beispiel 2.0.1 (Ist der Euro fair?)]
		...
		\begin{align*}
			\begin{tabular}{|c|c|c|c|c|c|c|}
				\hline
				\textbf{Land} & \textbf{n} & \textbf{S = $\#$Kopf} & \textbf{$T = (X - \frac{n}{2})$} & \textbf{c} & \textbf{Entscheidung}\\
				\hline
